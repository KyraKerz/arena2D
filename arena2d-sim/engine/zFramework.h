...
description: 
	- framework is a singleton class that handles the main window with events and openGL functions
*/
...
public:
	...
	int init(int windowW, int windowH, int windowX, int windowY, int multisamples, unsigned int flags);
